...
int main() {
	...
	int index = BMA(string, searchString, charJump);
	...
	data.data=0;
	printf("\t insert key: 7:\n");
	BSTInsert(&root, 7, &data);
	printBST(root);
	printf("\t insert key: 4:\n");
	BSTInsert(&root, 4, &data);
	printBST(root);
	printf("\t insert key: 9:\n");
	BSTInsert(&root, 9, &data);
	printBST(root);
	printf("\t insert key: 1:\n");
	BSTInsert(&root, 1, &data);
	printBST(root);
	printf("\t insert key: 6:\n");
	BSTInsert(&root, 6, &data);
	...
	BSTSearchTree(root, 15, &testNode);
	if(testNode==NULL){
