...
const char* ERR_MESSAGES[]={
		...
		[ERR_SEM_DEF] = "Nedefinovana promenna nebo funkce/ Pokus o redefinici promenne nebo funkce.\n",
		[ERR_SEM_COM] = "Chyba kompatibilty datoveho typu/chyba pri kontrole parametru .\n",
